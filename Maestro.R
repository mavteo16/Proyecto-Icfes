...
# ------------------------------------------------------------
cat(">>> [PASO 1/6] Ejecutando: CambiarNombres20141.R...\n")
...
# ------------------------------------------------------------
cat("\n>>> [PASO 3/6] Ejecutando: SABERPRO.R...\n")
source("R/SABERPRO.R")
...
# ------------------------------------------------------------
cat("\n>>> [PASO 5/6] Ejecutando: UNIFICACION.R...\n")
source("R/UNIFICACION.R")


# ------------------------------------------------------------
# PASO 6: Limpieza final, estandarización y validación matemática
# ------------------------------------------------------------
cat("\n>>> [PASO 6/6] Ejecutando: LIMPIEZAFINAL.R...\n")
