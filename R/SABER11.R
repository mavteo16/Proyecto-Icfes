...
rutas_archivos <- c(
  ...
  "20192" = file.path(ruta_principal, "Examen_Saber_11_20192.txt"),
  ...
  "20221" = file.path(ruta_principal, "Examen_Saber_11_20221.txt"),
  "20222" = file.path(ruta_principal, "Examen_Saber_11_20222.txt"),
  "20231" = file.path(ruta_principal, "Examen_Saber_11_20231.txt"),
